  ...
  render() {
    ...
    return (
      <View className="index">
        {this.state.isH5 ? <AtNavBar title="LzzTest"></AtNavBar> : null}
        <Swiper
                ...
                <View className="at-row">
                  <View className="at-col at-col-4">
                    <Image
                      mode="aspectFit"
                      className="card-img"
                      src={`${global.url}course/${item.img}`}
                    ></Image>
                  </View>
        ...
        {this.state.hasMore ? (
          ...
          <AtDivider content="没有更多了" color="#e93b3d"></AtDivider>
        )}
      </View>
    );
  }
